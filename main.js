  ...
  function completeTask() {
    ...
    var _loop3 = function _loop3(i) {
      taskCheckbox[i].addEventListener('click', function () {
        selectedProject.tasks[i].checked = selectedProject.tasks[i].checked != true;
      });
    };
